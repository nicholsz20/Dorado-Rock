...
const InstagramEmbed = () => {
  ...
  return (
    <blockquote
      ...
      data-instgrm-permalink="https://www.instagram.com/dorado.rock/?utm_source=ig_embed&amp;utm_campaign=loading"
    ...
    >
      <div style={{ padding: '16px' }}>
        <a
          href="https://www.instagram.com/dorado.rock/?utm_source=ig_embed&amp;utm_campaign=loading"
          style={{
            background: '#FFFFFF',
            lineHeight: '0',
            padding: '0 0',
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'row', marginBottom: '14px', alignItems: 'center' }}>
            <div>
              ...
              <div style={{ backgroundColor: '#F4F4F4', height: '12.5px', transform: 'rotate(-45deg) translateX(3px) translateY(1px)', width: '12.5px', marginRight: '14px', marginLeft: '2px' }}></div>
            ...
            <div style={{ marginLeft: 'auto' }}>
              ...
              <div style={{ backgroundColor: '#F4F4F4', height: '12px', width: '16px', transform: 'translateY(-4px)' }}></div>
